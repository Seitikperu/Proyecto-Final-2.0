...
import ModalMaterial from '@/components/almacen/ModalMaterial'
...
export default function Page() {
  ...
  const { data, count, totalPages, loading, refetch } = useMateriales(busqueda, page, PAGE_SIZE)
  ...
  const unidades = Array.from(new Set(data.map((m: Material) => m.unidad_medida).filter(Boolean))) as string[]
